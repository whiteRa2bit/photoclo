# API
* Authorization:
	* \api\sign_in - sign in account, require username and password.
	...
	* \api\sign_up - sign up account, require username, email and password.
	...
	* \api\sign_out - sign out account. If there is no open session, nothing return.
		* POST: nothing
